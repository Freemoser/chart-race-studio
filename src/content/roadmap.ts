...
export const POSTS: RoadmapPost[] = [
  {
    ...
    figures: ['1991: Ziervögel 6,8 Mio., Katzen 5,3 Mio., Hunde 4,6 Mio.', '2025: Katzen 15,7 Mio., Hunde 10,0 Mio., Ziervögel 3,3 Mio.'],
    sampleId: 'heimtiere', chart: 'line', dataStatus: 'belegt',
  },
  {
    nr: 2, arc: 'praxis', status: 'veroeffentlicht', publishedOn: '2026-09-16',
    title: 'Die Kleintierpraxis wird zum Normalfall',
    hook: 'Die logische Folgefrage zu Post 1: Was hat der Wandel bei den Tieren mit den Praxen gemacht? 1990 war die gemischte Praxis der Regelfall.',
    figures: ['1990: 2.741 gemischt, 1.953 nur Kleintiere, 1.206 nur Großtiere', '2002 Gleichstand auf die Person genau: 4.419 zu 4.419', '2025: 5.930 Kleintierpraxen, 54 Prozent aller Praxisinhaber'],
  ...
  },
  {
    ...
    figures: ['2026: IVC Evidensia 115 Standorte, Tierarzt Plus Partner 106, AniCura 69', 'Neun Gruppen zusammen rund 415 Standorte', 'zm-online 2022: „nicht mehr als 200“ bei rund 10.000 Praxen'],
    sampleId: 'ketten', chart: 'line', dataStatus: 'belegt',
    dataNote: 'Keine amtliche Statistik. Im Post sagen, dass die BTK Ketten nicht erhebt.',
    refs: [3],
  },
  {
  ...
  },
  {
    ...
    figures: ['Über 1.300 Mitgliedspraxen in Deutschland, über 5.000 weltweit', '2000 in Dänemark von 13 selbstständigen Tierärzten gegründet', 'Besitzt keine einzige Praxis'],
  ...
  },
  {
    ...
    figures: ['filu: 8 Praxen, über 100 Mitarbeitende', 'Rex: 9 Praxen', 'Beide konzentriert auf Großstädte, mit App-Terminbuchung und Preistransparenz'],
    dataStatus: 'teilweise',
  ...
  },
  {
    ...
    figures: ['2025: 1.098 Mio. Euro, plus 4,7 Prozent', 'Heimtiere stehen für 60,6 Prozent des Umsatzes'],
    dataStatus: 'offen',
    dataNote: 'Bisher nur der Wert für 2025 aus der Jahresmeldung des Bundesverbands für Tiergesundheit. Für ein Video braucht es die Reihe der Vorjahre, die der BfT jährlich veröffentlicht.',
    refs: [25],
  },
  {
    ...
    figures: ['2025: 66,8 Prozent der Kammermitglieder sind Frauen', '71,7 Prozent der tierärztlich Tätigen', 'Zu prüfen: wie sich das auf die Inhaberquote aus Post 3 legt'],
    dataStatus: 'teilweise',
    dataNote: 'Der Stand 2025 ist aus der BTK-Meldung belegt. Die Reihe seit 1991 steht in den Jahrgängen der Statistik und muss noch ausgelesen werden – dieselbe Quelle wie Datensatz 1.',
    refs: [3],
  },
  {
