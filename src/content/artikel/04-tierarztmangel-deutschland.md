...
- Hunde und Katzen zusammen: 19,7 Millionen im Jahr 2012, 25,7 Millionen im Jahr 2025, ein Plus von 30,5 Prozent (berechnet).
- Die Zahl der Praxisinhaber sank im selben Zeitraum von 11.906 auf 11.216, minus 5,8 Prozent.
- Je Inhaber stieg die Zahl der Hunde und Katzen damit um 38,5 Prozent, von 1.655 auf 2.291.
- Die angestellten Tierärztinnen und Tierärzte in Praxen haben sich fast verdoppelt, von 6.346 auf 12.125.
- Je Tierärztin oder Tierarzt in der Praxis, Inhaber und Angestellte zusammen, stieg der Wert nur um 2,0 Prozent, von 1.079 auf 1.101.

## Zwei Kurven, die auseinanderlaufen

| Jahr | Hunde und Katzen | Praxisinhaber | je Inhaber | je Tierärztin/Tierarzt in Praxen |
|---|---:|---:|---:|---:|
| 2012 | 19,7 Mio. | 11.906 | 1.655 | 1.079 |
| 2013 | 18,4 Mio. | 11.938 | 1.541 | 988 |
| 2016 | 22,0 Mio. | 11.972 | 1.838 | 1.105 |
| 2019 | 24,8 Mio. | 12.019 | 2.063 | 1.161 |
| 2021 | 27,0 Mio. | 11.889 | 2.271 | 1.221 |
| 2023 | 26,2 Mio. | 11.437 | 2.291 | 1.146 |
| 2025 | 25,7 Mio. | 11.216 | 2.291 | 1.101 |

*Die beiden rechten Spalten sind berechnet: Hunde und Katzen geteilt durch Praxisinhaber beziehungsweise durch Praxisinhaber plus angestellte Tierärztinnen und Tierärzte in Praxen.*

Bis 2019 wuchs die Zahl der Inhaber noch leicht, die der Hunde und Katzen deutlich schneller. Seit 2020 gehen die Inhaber zurück, während die Tierzahlen bis 2021 weiter steigen und danach knapp darunter bleiben. Den Höchstwert erreicht die Kennzahl 2024 mit 2.344 Hunden und Katzen je Inhaber, 2025 liegt sie wieder bei 2.291 – genau wie 2023.
...
## Warum der Vergleich erst 2012 beginnt
...
- **Inhaber sind nicht Praxen.** In Gemeinschaftspraxen teilen sich mehrere Inhaber einen Betrieb. Der Tierärzte Atlas nennt rund 10.000 Praxen und Kliniken.
- **Personen, keine Vollzeitstellen.** Das betrifft vor allem die Spalte mit den Angestellten.
- **Tiermedizinische Fachangestellte fehlen.** Sie sind keine Kammermitglieder und in keiner der Reihen enthalten.
- **Heimtierzahlen sind Hochrechnungen** aus Haushaltsbefragungen, es gibt kein Register. Der Bruch 2012 und die Umstellung 2013 verschieben jede Kennzahl, die auf ihnen beruht.
...
Tierärztinnen und Tierärzte: Statistik der Deutschen Tierärzteschaft der [Bundestierärztekammer](https://www.bundestieraerztekammer.de/btk/statistik/), Deutsches Tierärzteblatt, Stichtag jeweils 31. Dezember. Hunde und Katzen: IVH und ZZF, „Der Deutsche Heimtiermarkt“, bis 2011 Verbandsschätzung, 2012 IMR-Erhebung, ab 2013 Skopos. Berechnet sind alle Quotienten und Veränderungsraten; die Heimtierzahlen in Millionen sind vor der Division in Stück umgerechnet. Mehr unter [Datenherkunft](../artikel/datenherkunft.html).
